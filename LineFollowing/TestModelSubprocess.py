...
from .VesselEnvLineFollowing import VesselEnv
import os

models_dir = "LineFollowing/LineFollowingModels/PPO-1761720212" 
model_path = os.path.join(models_dir, "1104000")  # path to the saved .zip
vecnorm_path = os.path.join(models_dir, "vecnormalize_1104000.pkl")
